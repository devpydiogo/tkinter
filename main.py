...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            print(
                f'Title: {title} Firstname: {firstname} Lastname: {lastname}')
            print(f'Age: {age} Nationality: {nationality}')
            print(f'Registration_status: {registration_status}')
            print(f'Num courses: {numcourses} Num Semesters: {numsemesters}')
            print('-' * 100)
...
title_combobox = ttk.Combobox(
    user_info_frame, values=["", "Mr.", "Ms.", "Dr."]
)
...
nationality_combobox = ttk.Combobox(user_info_frame, values=[
                                    "Africa", "Antartica", "Asia", "Europe", "South America"])
...
terms_check = tkinter.Checkbutton(
    terms_frame, text="I accept the terms and conditions.", variable=accept_var, onvalue="Accepted", offvalue="Not Accepted")
